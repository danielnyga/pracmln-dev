  ...
  */
    ...
    main : function() {
	    ...
	    buttonStart.addListener("execute",function(e) {
                            win2.close();
                            //resultStrings.push(selectMLN.getSelection()[0].getLabel());
                            //resultProb.push(0.5);
    ...
    /*
        ...
        function d3Update() {
            ...
            prob = prob.data(force.links(), function(d) { return d.source.id + "-" + d.target.id; });
                    prob.enter().append("text").text(function(d) { return "HALLO"; });
                    prob.exit().remove();
            ...
            text = text.data(force.nodes(), function(d) { return d.id;});
                    text.enter().append("text").text(function(d) { return d.name; });
                    text.exit().remove();        
